...
| [AC-build.md](acceptance-criteria/AC-build.md)             | AC-BUILD-001~002（Babel/.tsx 构建管线）         |
...
| [AC-pwa.md](acceptance-criteria/AC-pwa.md)                 | AC-PWA-001~003（PWA 安装壳 + Web Share Target） |
