          ...
          <div className="flex items-center gap-2">
            {hasContent && (
              <button
                ...
                onClick={() => setVisionShowTranslatedOnly(!visionShowTranslatedOnly)}
              ...
              {photos.map(({ i }) => {
                ...
                return (
                  <div key={i} className="px-3.5 py-2.5">
                    {aiInfo?.status === 'error' && (
                      <p className="text-[13px] leading-relaxed break-words text-destructive">
                        {aiInfo.error}
                      </p>
                    )}
                    {view.originalText && view.displayText !== view.originalText && (
                    ...
                    {view.displayText && (
                      <p className={cn(
                        ...
                        view.originalText && view.displayText !== view.originalText && 'mt-1 font-medium',
                      )}
                      >
                        {view.displayText}
                      </p>
