 ...
 */
export function AIVisionEditorDialog({
  editor,
}: {
  editor: ReturnType<typeof useVisionLogic>
}) {
  const hasOcr
    = editor.mode === 'ocr' || editor.visionInfo.some(v => v.mode === 'ocr')
      ...
      <DialogContent className="max-w-xl">
        ...
        <DialogPanel className="space-y-4">
          ...
          <ToggleGroup
            ...
            value={[editor.mode]}
            onValueChange={value =>
              value.length > 0 && editor.setMode(value[0] as VisionMode)}
          >
              ...
              {editor.photoIndexes.map((i) => {
                ...
                return (
                  <div key={i} className="px-4 py-3">
                    {aiInfo?.status === 'error' && (
                      <p className="pb-2 text-xs break-words text-destructive">
                        {aiInfo.error}
                      </p>
                    )}
        ...
        <DialogFooter className="flex-row items-center justify-end gap-2">
          {hasOcr && (
            ...
            >
              ...
              <span className="hidden sm:inline-block">翻译</span>
            </Button>
          )}
          <Button
            variant="outline"
          ...
          >
            ...
            <span className="hidden sm:inline-block">生成</span>
          </Button>
