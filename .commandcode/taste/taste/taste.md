...
- Doesn't want to be asked for confirmation on routine/mechanical actions (e.g. committing): says "commit everything per convention, no need to check with me" and expects the agent to just proceed. Confidence: 0.65
